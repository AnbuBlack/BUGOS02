import  time
import cv2 as cv
import tkinter as Tk #https://www.tutorialspoint.com/how-to-install-tkinter-in-python
from PIL import Image, ImageTk#http://2017.compciv.org/guide/topics/python-nonstandard-libraries/pillow.html
import receive_data
...
class create_UI:
    ...
    def __init__(self):
        ...
        val_temp.place(x=900,y=50)
        val_humi.place(x=900,y=80)
        val_wave.place(x=900,y=110)
